...
var AccessControl = (function () {
    ...
    AccessControl.prototype.setGrants = function (grantsObject) {
        var _this = this;
        this._grants = {};
        var type = helper_1.default.type(grantsObject);
        if (type === 'object') {
            this._grants = grantsObject;
        }
        else if (type === 'array') {
            grantsObject.forEach(function (item) { return helper_1.default.commitToGrants(_this._grants, item, true); });
        }
        return this;
    };
    /**
    ...
    AccessControl.prototype.extendRole = function (roles, extenderRoles) {
        helper_1.default.extendRole(this._grants, roles, extenderRoles);
        return this;
    };
    /**
    ...
    AccessControl.prototype.removeRoles = function (roles) {
        var _this = this;
        var rolesToRemove = helper_1.default.toStringArray(roles);
        ...
        this._each(function (role, roleItem) {
            if (Array.isArray(roleItem.$extend)) {
                roleItem.$extend = helper_1.default.subtractArray(roleItem.$extend, rolesToRemove);
            }
        });
        return this;
    };
    ...
    AccessControl.prototype._each = function (callback) {
        var _this = this;
        helper_1.default.eachKey(this._grants, function (role) { return callback(role, _this._grants[role]); });
    };
    /**
     *  @private
     */
    AccessControl.prototype._eachRole = function (callback) {
        helper_1.default.eachKey(this._grants, function (role) { return callback(role); });
    };
    /**
     *  @private
     */
    AccessControl.prototype._eachRoleResource = function (callback) {
        ...
        this._eachRole(function (role) {
            ...
            helper_1.default.eachKey(resources, function (resource) {
    ...
    AccessControl.prototype._removePermission = function (resources, roles, actionPossession) {
        var _this = this;
        resources = helper_1.default.toStringArray(resources);
        if (roles)
            roles = helper_1.default.toStringArray(roles);
        this._eachRoleResource(function (role, resource, permissions) {
    ...
    AccessControl.filter = function (data, attributes) {
        helper_1.default.filterAll(data, attributes);
    };
    /**
