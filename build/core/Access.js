...
var Access = (function () {
    ...
    function Access(grants, roleOrInfo, denied) {
        ...
        if (typeof roleOrInfo === 'string' || Array.isArray(roleOrInfo)) {
        ...
        else if (helper_1.default.type(roleOrInfo) === 'object') {
            ...
            this._ = helper_1.default.resetAttributes(roleOrInfo);
            if (helper_1.default.isInfoFulfilled(this._))
                helper_1.default.commitToGrants(this._grants, this._, true);
        }
    }
    ...
    Access.prototype.extend = function (roles) {
        helper_1.default.extendRole(this._grants, this._.role, roles);
        return this;
    };
    /**
    ...
    Access.prototype._prepareAndCommit = function (action, possession, resource, attributes) {
        ...
        if (this._.denied) {
            ...
            this._.attributes = this._.attributes ? helper_1.default.toStringArray(this._.attributes) : ['*'];
        }
        helper_1.default.commitToGrants(this._grants, this._, false);
