...
var AccessControl = /** @class */ (function () {
    ...
    AccessControl.prototype.removeRoles = function (roles) {
        ...
        if (
            ...
            !utils_1.utils.isFilledStringArray(rolesToRemove)
        ) {
        ...
        utils_1.utils.eachRole(this._grants, function (roleItem, roleName) {
            if (Array.isArray(roleItem.$extend)) {
                roleItem.$extend = utils_1.utils.subtractArray(
                    roleItem.$extend,
                    rolesToRemove,
                );
            }
    ...
    AccessControl.prototype.hasRole = function (role) {
        ...
        if (Array.isArray(role)) {
            return role.every(function (item) {
                return _this._grants.hasOwnProperty(item);
            });
        }
    ...
    AccessControl.prototype.hasResource = function (resource) {
        ...
        if (Array.isArray(resource)) {
            return resource.every(function (item) {
                return resources.indexOf(item) >= 0;
            });
        }
     ...
     *  @private
     */
    AccessControl.prototype._removePermission = function (
        resources,
        roles,
        actionPossession,
    ) {
        ...
        if (
            resources.length === 0 ||
            !utils_1.utils.isFilledStringArray(resources)
        ) {
            throw new core_1.AccessControlError(
        ...
        utils_1.utils.eachRoleResource(this._grants, function (
            role,
            resource,
            permissions,
        ) {
            if (
                ...
                if (actionPossession) {
                    ...
                    var ap = utils_1.utils.normalizeActionPossession(
