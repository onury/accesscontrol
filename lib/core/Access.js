...
var Access = /** @class */ (function () {
    ...
    Access.prototype.createOwn = function (resource, attributes) {
        return this._prepareAndCommit(
            enums_1.Action.CREATE,
            enums_1.Possession.OWN,
            resource,
            attributes,
        );
    };
     ...
     *           Self instance of `Access`.
     */
    Access.prototype._prepareAndCommit = function (
        action,
        possession,
        resource,
        attributes,
        ...
        if (this._.denied) {
            ...
            this._.attributes = attributes
                ? utils_1.utils.toStringArray(attributes)
                : ['*'];
        }
