...
describe('Test Suite: Access Control', () => {
    'use strict';
    ...
    test('deny should auto-set attributes to []', () => {
        const ac = new AccessControl();
    ...
    test('permission should also return queried role(s) and resource', () => {
        const ac = new AccessControl();
        // also supporting comma/semi-colon separated roles
    ...
    test('filter granted attributes', () => {
        const ac = new AccessControl();
    ...
    test('filter given data (static filter method)', () => {
        let o = {
            name: 'John',
            age: 30,
            account: {
    ...
    test('lock AccessControl instance', () => {
        let ac;
